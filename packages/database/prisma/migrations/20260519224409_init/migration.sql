...
-- CreateEnum
CREATE TYPE "tenant_status" AS ENUM ('ACTIVE', 'INACTIVE', 'TRIAL', 'EXPIRED', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "audit_action" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'LOGIN_FAILED', 'PASSWORD_CHANGE', 'PASSWORD_RESET', 'PERMISSION_GRANT', 'PERMISSION_REVOKE');
